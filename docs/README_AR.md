...
137 Agent. 269 skill. 60 hook. بدون أي عمل يدوي.
...
يحول vibecosystem أداة Claude Code إلى فريق برمجيات ذكاء اصطناعي متكامل. ليس مساعدا واحدا، بل **فريق** من 137 agent متخصصا يخطط ويبني ويراجع ويختبر ويتعلم من كل خطأ.
