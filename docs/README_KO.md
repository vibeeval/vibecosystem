...
119개의 Agent. 208개의 Skill. 49개의 Hook. 수동 작업 제로.
...
vibecosystem은 Claude Code를 완전한 AI 소프트웨어 팀으로 바꿉니다. 단순한 어시스턴트가 아닌, 설계하고, 구축하고, 리뷰하고, 테스트하고, 모든 실수로부터 학습하는 119개의 전문 agent로 구성된 **팀**입니다.
