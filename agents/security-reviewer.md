...
|-------|-------|--------------------|
| Secret taraması | secret-patterns | Regex library, entropy detection, false positive filtering |
| Dependency audit | supply-chain-security | Typosquatting, install script, dependency confusion |
| Race condition | concurrency-security | TOCTOU, distributed lock, double-submit prevention |
| API review | api-patterns | Input validation, auth flow, error response |
